.PHONY: help build up start down destroy stop restart logs logs-api ps login-web login-api db-shell
...
# Run python tests
py-test:
	docker compose -f docker-compose.yml exec web ./scripts/cmd-test.sh $(c)
