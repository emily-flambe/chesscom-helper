...
from chesscom_app.services import send_live_match_notification, check_and_notify_all_users
...
class EmailNotificationTestCase(TestCase):
    ...
    def test_check_and_notify_all_users(self, mock_update_status, mock_send_notification):
