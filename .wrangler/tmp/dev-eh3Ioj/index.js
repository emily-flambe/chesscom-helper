...
// .wrangler/tmp/bundle-McKnRQ/checked-fetch.js
...
// .wrangler/tmp/bundle-McKnRQ/strip-cf-connecting-ip-header.js
...
var src_default = {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/api/auth-test" && request.method === "POST") {
      return new Response(JSON.stringify({ message: "Auth endpoint working" }), {
        headers: { "Content-Type": "application/json" }
      });
    }
...
// .wrangler/tmp/bundle-McKnRQ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-McKnRQ/middleware-loader.entry.ts
