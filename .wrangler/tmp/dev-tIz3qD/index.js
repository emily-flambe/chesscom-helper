...
// .wrangler/tmp/bundle-2SFYcY/checked-fetch.js
...
// .wrangler/tmp/bundle-2SFYcY/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-2SFYcY/middleware-loader.entry.ts
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();

// .wrangler/tmp/bundle-2SFYcY/middleware-insertion-facade.js
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
...
router5.all("/api/v1/auth/*", router);
router5.all("/api/v1/users/*", authenticateUser, router2);
router5.all("/api/v1/monitoring/*", authenticateUser, router3);
router5.all("/api/v1/notifications/*", authenticateUser, router4);
